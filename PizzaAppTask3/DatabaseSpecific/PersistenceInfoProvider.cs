...
namespace PizzaApp.DatabaseSpecific
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		{
			this.AddElementMapping("OrdersListEntity", @"pizza_app", @"public", "orders_list", 4, 0);
			this.AddElementFieldMapping("OrdersListEntity", "CreatedAt", "created_at", false, "Timestamp", 0, 0, 0, false, "", null, typeof(System.DateTime), 0);
			this.AddElementFieldMapping("OrdersListEntity", "Id", "id", false, "Integer", 0, 10, 0, true, "public.orders_list_id_seq", null, typeof(System.Int32), 1);
			this.AddElementFieldMapping("OrdersListEntity", "NumberOfPizzas", "number_of_pizzas", false, "Integer", 0, 10, 0, false, "", null, typeof(System.Int32), 2);
			this.AddElementFieldMapping("OrdersListEntity", "TotalPrice", "total_price", false, "Double", 0, 38, 0, false, "", null, typeof(System.Double), 3);
		}
