...
namespace PizzaApp.EntityClasses
{
	...
	
	{
		...
		protected class PizzaToppingEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("PizzaToppingEntity", InheritanceHierarchyType.None, false, (int)PizzaApp.EntityType.PizzaToppingEntity, typeof(PizzaToppingEntity), typeof(PizzaToppingEntityFactory), false);
			}
		}
		...
		/// <summary>The Toppings property of the Entity PizzaTopping<br/><br/></summary>
		/// <remarks>Mapped on  table field: "pizza_toppings"."toppings".<br/>Table field type characteristics (type, precision, scale, length): Text, 0, 0, 1073741824.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Toppings
		{
			get { return (System.String)GetValue((int)PizzaToppingFieldIndex.Toppings, true); }
			set	{ SetValue((int)PizzaToppingFieldIndex.Toppings, value); }
		}
