...
namespace PizzaApp.EntityClasses
{
	...
	
	{
		...
		protected class PizzaSizeEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("PizzaSizeEntity", InheritanceHierarchyType.None, false, (int)PizzaApp.EntityType.PizzaSizeEntity, typeof(PizzaSizeEntity), typeof(PizzaSizeEntityFactory), false);
			}
		}
