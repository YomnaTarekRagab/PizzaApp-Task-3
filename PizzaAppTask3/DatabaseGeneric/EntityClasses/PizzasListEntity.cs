...
namespace PizzaApp.EntityClasses
{
	...
	
	{
		...
		protected class PizzasListEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("PizzasListEntity", InheritanceHierarchyType.None, false, (int)PizzaApp.EntityType.PizzasListEntity, typeof(PizzasListEntity), typeof(PizzasListEntityFactory), false);
				AddNavigatorMetaData<PizzasListEntity, OrdersListEntity>("OrdersList", "PizzasLists", (a, b) => a._ordersList = b, a => a._ordersList, (a, b) => a.OrdersList = b, PizzaApp.RelationClasses.StaticPizzasListRelations.OrdersListEntityUsingOrdersIdStatic, ()=>new PizzasListRelations().OrdersListEntityUsingOrdersId, null, new int[] { (int)PizzasListFieldIndex.OrdersId }, null, true, (int)PizzaApp.EntityType.OrdersListEntity);
			}
		}
