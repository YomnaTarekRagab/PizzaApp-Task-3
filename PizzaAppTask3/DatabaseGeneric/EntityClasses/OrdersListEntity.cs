...
namespace PizzaApp.EntityClasses
{
	...
	
	{
		...
		protected class OrdersListEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("OrdersListEntity", InheritanceHierarchyType.None, false, (int)PizzaApp.EntityType.OrdersListEntity, typeof(OrdersListEntity), typeof(OrdersListEntityFactory), false);
				AddNavigatorMetaData<OrdersListEntity, EntityCollection<PizzasListEntity>>("PizzasLists", a => a._pizzasLists, (a, b) => a._pizzasLists = b, a => a.PizzasLists, () => new OrdersListRelations().PizzasListEntityUsingOrdersId, typeof(PizzasListEntity), (int)PizzaApp.EntityType.PizzasListEntity);
			}
		}
		...
		/// <summary>The CreatedAt property of the Entity OrdersList<br/><br/></summary>
		/// <remarks>Mapped on  table field: "orders_list"."created_at".<br/>Table field type characteristics (type, precision, scale, length): Timestamp, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime CreatedAt
		{
			get { return (System.DateTime)GetValue((int)OrdersListFieldIndex.CreatedAt, true); }
			set	{ SetValue((int)OrdersListFieldIndex.CreatedAt, value); }
		}
...
namespace PizzaApp.RelationClasses
{
